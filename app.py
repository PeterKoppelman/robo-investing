...
# from apps import contact_layout, contact_callbacks, reference, welcome, calc_portfolio_dbc
from apps import layout, callbacks, screens
...
def render_page_content(pathname):
    if pathname == '/page-1':
        ...
        return layout.sample_portfolio_layout(app)
...
# callbacks
callbacks.contact_callback(app)
callbacks.sample_portfolio_callback(app)
